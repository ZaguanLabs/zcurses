...
unmodified upstream licence lives in `upstream/LICENCE`; the root `LICENCE`
adds the project-specific declaration and is not part of this immutable manifest.
The original build descriptor and key generator were moved here when the working
