...
test: build
	...
	@for file in lib/zdraw-ui.zsh lib/zdraw-panel.zsh lib/zdraw-list.zsh lib/zdraw-layout.zsh lib/zdraw-table.zsh lib/zdraw-tabs.zsh lib/zdraw-meter.zsh lib/zdraw-badge.zsh lib/zdraw-help.zsh lib/zdraw-input.zsh lib/zdraw-form.zsh lib/ui/*.zsh tests/ui*.zsh tests/gallery.zsh tests/composition.zsh examples/gallery.zsh examples/list-detail.zsh examples/table-inspector.zsh examples/task-monitor.zsh examples/form.zsh; do \
